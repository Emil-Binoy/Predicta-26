...
const Prediction = () => {
    ...
    const [predictionId, setPredictionId] = useState(location.state?.predictionId || '');
    ...
    const onSubmit = async (e) => {
        ...
        if (!winningMargin) {
            toast.error('Please select the winning margin');
            return;
        }
        ...
        <div className="pt-24 pb-12 min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
            ...
            >
                ...
                <form onSubmit={onSubmit} className="space-y-8">
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-300 mb-1">Winning Margin</label>
                        <input 
                            value={winningMargin}
                    ...
                    {winningTeam && winningMargin && (
                        ...
                        >
                            <p className="text-[#50c878] font-medium">
                                You predict <span className="font-bold text-white">{winningTeam}</span> to win by <span className="font-bold text-white">{winningMargin}</span>.
                            </p>
                        </motion.div>
                    )}
